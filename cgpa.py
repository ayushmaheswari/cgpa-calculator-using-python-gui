...
dire1=Label(win,text="Tgpa1:",bg="#00ffcc",font="Times 11 bold") #label
...
dire1=Label(win,text="Tgpa2:",bg="#00ffcc",font="Times 11 bold") #label
...
pos8 = Label(win,text = "Tgpa1:",bg="#00ffcc",font="Times 11 bold") #label
pos8.grid(row=32,column=1)
pos8=Label(win,textvariable=pos3,bg="#00ffcc") #label
pos8.grid(row=32,column=6)

pos9 = Label(win,text = "Tgpa2:",bg="#00ffcc",font="Times 11 bold") #label
